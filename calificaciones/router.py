...
def crear_calificacion(titulo: str = Form(...), 
    ...
    calificacion = schemas.Calificacion_a_Crear(
...
def modificar_calificacion(id : int, calificacion: schemas.Calificacion_a_Crear, db: Session = Depends(get_db), info=Depends(auth_handler.auth_wrapper)): 
